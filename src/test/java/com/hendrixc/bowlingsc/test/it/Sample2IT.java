...
/**
 * Integration Test Case for sample2 file.
 *
 * @author Henry Coral
 */
public class Sample2IT {

    private static final Logger LOG = Logger.getLogger(Sample2IT.class.getName());
    ...
    public void testScore() {
        try {
            String fileName1 = resourcesDirectory+File.separator+"sample2.txt";
            ...
            String expected = "" +
                    ...
                    "Jeff\n" +
                    "Pinfalls	9	/	9	/	9	/	9	/	9	/	9	/	9	/	9	/	9	/	9	1	0\n" +
                    "Score		19		38		57		76		95		114		133		152		171		181\n";
